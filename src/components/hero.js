...
export default function Hero() {
    return (
        <div>
            <div className='container d-lg-flex py-5 align-items-sm-center justify-content-center'>
            ...
            <div className='three'>
                <div className='container px-5 d-flex flex-md-row justify-content-between py-2'>
